...
namespace AnaCSharp.DAL.Migrations
{
    ...
    [Migration("20190311212934_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnaCSharp.DAL.Model.Chat", b =>
                {
            ...
            modelBuilder.Entity("AnaCSharp.DAL.Model.LogWord", b =>
                {
                    b.Property<int>("LogWordId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AnaCSharp.DAL.Model.MaxMarkovDegree", b =>
                {
                    b.Property<int>("MaxMarkovDegreeId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("Value");

                    b.HasKey("MaxMarkovDegreeId");

                    b.ToTable("MaxMarkovDegrees");
                });
            ...
            modelBuilder.Entity("AnaCSharp.DAL.Model.LogWord", b =>
                {
                    b.HasOne("AnaCSharp.DAL.Model.Chat", "Chat")
                        .WithMany()
